...
- **Database drivers**: pg, mysql2, sqlite3, psycopg2, pymysql, redis, pymongo
...
18 MCP tools available — AI agents can query runtime data, detect issues, and apply fixes without human intervention.
